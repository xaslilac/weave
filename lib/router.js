...
module.exports = function router() {
  ...
  let print = more => {
    this.app._resolvedPaths[ this.requestUrl.pathname ] = more
  ...
  if ( this.app._resolvedPaths[ this.relativeUrl.pathname ] ) {
    return print( this.app._resolvedPaths[ this.relativeUrl.pathname ] )
  }
  ...
  const reroute = () => {
    ...
    let nextStep = path.join( this.relativeUrl.pathname, '..' )
    this.relativeUrl.suffix = path.join( path.relative( nextStep, this.relativeUrl.pathname ), this.relativeUrl.suffix )
    this.relativeUrl.pathname = nextStep
