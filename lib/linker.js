...
module.exports = function linkToBinding() {
  ...
  if ( binding.attachments[ this.requestUrl.hostname ] ) {
    ...
    if ( !hostnameSpirit ) {
      ...
      return this.generateErrorPage( new weave.HttpError( 503, 'This app is not currently active.' ) )
    }
